...
//  WTAdvertising
//
//  Created by wangtao on 2018/12/24.
//  Copyright © 2018年 wangtao. All rights reserved.
//

#import "WTAdvertiseViewController.h"

@interface WTAdvertiseViewController ()<UIScrollViewDelegate>
...
- (void)tapGes:(UITapGestureRecognizer *)tapGes {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"WTTapAdvertisingNotification" object:nil userInfo:@{@"info":@(page)}];
}
